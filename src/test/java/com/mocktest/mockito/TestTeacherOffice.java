...
public class TestTeacherOffice {
  ...
  public void testGetTeacherOfficeHoursInfo() {
    ...
    assertEquals(teacher.period, Period.MORNING);
  }
  ...
  @Test
  public void testIsPeriodCorrect() {
    String teachers = TeacherConst.concatIntoJsonArray(TeacherConst.TEACHER_9, TeacherConst.TEACHER_10);
    Mockito.when(service.fetchData()).thenReturn(teachers);

    TeacherOfficeHoursModel teacher = controller.getTeacherOfficeHoursInfo("George Harris");
    assertEquals(teacher.period, Period.AFTERNOON);
  }

  @Test
  public void testIsPeriodNotCorrect() {
    String teachers = TeacherConst.concatIntoJsonArray(TeacherConst.TEACHER_9, TeacherConst.TEACHER_10);
    Mockito.when(service.fetchData()).thenReturn(teachers);

    TeacherOfficeHoursModel teacher = controller.getTeacherOfficeHoursInfo("Hannah White");
    assertNotEquals(teacher.period, Period.MORNING);
  }

  @Test
  public void testIsTeacherAvailableForAfternoonPeriod() {
    String teachers = TeacherConst.concatIntoJsonArray(TeacherConst.TEACHER_5, TeacherConst.TEACHER_6);
    Mockito.when(service.fetchData()).thenReturn(teachers);

    boolean isTeacherAvailable = controller.isTeacherAvailable("Charlie Davis", "3:00 PM - 4:00 PM");
    assertTrue(isTeacherAvailable);
  }
